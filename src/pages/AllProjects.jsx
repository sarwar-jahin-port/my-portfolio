...
const AllProjects = () => {
  ...
  const categories = [
    { id: "all", name: "All Projects", count: projectList.length },
    {
      ...
      count: projectList.filter(
        (p) => p.category.toLowerCase() === "full stack"
      ).length,
    },
    {
      id: "frontend",
      name: "Frontend",
      count: projectList.filter((p) => p.category.toLowerCase() === "frontend")
        .length,
    },
    {
      id: "backend",
      name: "Backend",
      count: projectList.filter((p) => p.category.toLowerCase() === "backend")
        .length,
    },
  ];
  ...
  const regularProjects = filteredAndSortedProjects.filter(
    (project) => !project.featured || filter !== "all" || searchTerm
  );
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
              A comprehensive collection of my development work, showcasing
              various technologies, innovative solutions, and creative
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {featuredProjects.slice(0, 2).map((project) => (
                  <div
                    key={project.id}
                    className="bg-slate-800/30 backdrop-blur-sm border border-slate-700 rounded-2xl overflow-hidden hover:border-blue-500/50 transition-all duration-300 group"
                  >
