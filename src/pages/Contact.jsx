            ...
            <div className="lg:col-span-2 space-y-8">
                ...
                <div className="space-y-6">
                  <div className="group flex items-start gap-4 p-4 rounded-xl hover:bg-slate-700/30 transition-all duration-300">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-400 mt-1">I typically respond within 24 hours</p>
                    </div>
                  </div>
                  ...
                  <div className="group flex items-start gap-4 p-4 rounded-xl hover:bg-slate-700/30 transition-all duration-300">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300">+880 123 456 7890</p>
                      <p className="text-sm text-slate-400 mt-1">Available Mon-Fri, 9AM-6PM</p>
                    </div>
                  </div>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50">
                ...
                <div className="flex gap-4">
                  ...
                  >
                    ...
                    <p className="text-sm text-slate-400 group-hover:text-slate-300">GitHub</p>
                  </a>
                  <a 
                  ...
                  >
                    ...
                    <p className="text-sm text-slate-400 group-hover:text-slate-300">LinkedIn</p>
                  </a>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-2xl p-6 border border-blue-500/20">
                ...
                <p className="text-slate-300 text-sm">
                  I aim to respond to all messages within 24 hours. For urgent matters, 
